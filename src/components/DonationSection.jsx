...
export default function DonationSection() {
  ...
  return (
    <>
      {/* SECTION DONATION */}
      <div className="mb-8 relative bg-gradient-to-br from-[#1a1d3f]/90 to-[#0a0e27]/90 border-4 border-purple-400 rounded-3xl p-4 sm:p-6 shadow-[0_20px_60px_rgba(168,85,247,0.3)] overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="text-center mb-5">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-purple-400 mb-2 px-2">
              {t("donation.title")}
            </h2>
          ...
          <div className="mb-5">
            ...
            <div className="relative h-8 bg-gray-800/50 rounded-full overflow-hidden border-2 border-purple-400/30">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="text-white font-bold text-xs sm:text-sm drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)] px-2">
          ...
          {/* CORRECTION ICI - Grid responsive avec text plus petit sur mobile */}
          <div className="grid grid-cols-3 gap-2 sm:gap-3 mb-5">
            <div className="bg-purple-400/10 border-2 border-purple-400/50 rounded-xl p-2 sm:p-3 text-center overflow-hidden">
              <div className="text-base sm:text-xl md:text-2xl font-bold text-purple-400 break-words px-1">
                560 TH/s
              </div>
              <div className="text-[9px] sm:text-[10px] text-gray-400 mt-1">{t("donation.hashrate")}</div>
            </div>
            <div className="bg-pink-400/10 border-2 border-pink-400/50 rounded-xl p-2 sm:p-3 text-center overflow-hidden">
              <div className="text-base sm:text-xl md:text-2xl font-bold text-pink-400 break-words px-1">
                3.125 BTC
              </div>
              <div className="text-[9px] sm:text-[10px] text-gray-400 mt-1">{t("donation.jackpot")}</div>
            </div>
            <div className="bg-cyan-400/10 border-2 border-cyan-400/50 rounded-xl p-2 sm:p-3 text-center overflow-hidden">
              <div className="text-base sm:text-xl md:text-2xl font-bold text-cyan-400 break-words px-1">
                {remainingAmount.toLocaleString()}€
              </div>
              <div className="text-[9px] sm:text-[10px] text-gray-400 mt-1">{t("donation.remaining")}</div>
            </div>
          </div>
          ...
          <div className="flex gap-2 sm:gap-3 mb-4">
            <button 
              ...
              className="flex-1 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-bold py-2.5 sm:py-3 px-3 sm:px-4 rounded-xl hover:scale-105 hover:shadow-2xl transition-all shadow-lg text-sm sm:text-base"
            >
              🎁 {t("donation.donate_button")}
            </button>
            <button
              onClick={() => setShowDetailsModal(true)}
              className="bg-yellow-400/10 border-2 border-yellow-400 text-yellow-400 font-bold py-2.5 sm:py-3 px-4 sm:px-6 rounded-xl hover:bg-yellow-400/20 transition-all whitespace-nowrap text-sm sm:text-base"
            >
      ...
      {showDetailsModal && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={() => setShowDetailsModal(false)}>
          <div className="bg-gradient-to-br from-[#1a1d3f] to-[#0a0e27] border-4 border-yellow-400 rounded-3xl p-6 sm:p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-[0_0_100px_rgba(255,215,0,0.5)]" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="space-y-6">
              {/* Le Projet */}
              <div className="bg-[#0a0e27] border-2 border-purple-400/50 rounded-xl p-4 sm:p-5">
                <h4 className="text-lg sm:text-xl font-bold text-purple-400 mb-3 flex items-center gap-2">
              ...
              {/* Les Machines */}
              <div className="bg-[#0a0e27] border-2 border-cyan-400/50 rounded-xl p-4 sm:p-5">
                <h4 className="text-lg sm:text-xl font-bold text-cyan-400 mb-3 flex items-center gap-2">
              ...
              {/* Comment ça marche */}
              <div className="bg-[#0a0e27] border-2 border-green-400/50 rounded-xl p-4 sm:p-5">
                <h4 className="text-lg sm:text-xl font-bold text-green-400 mb-3 flex items-center gap-2">
              ...
              {/* Garanties */}
              <div className="bg-[#0a0e27] border-2 border-blue-400/50 rounded-xl p-4 sm:p-5">
                <h4 className="text-lg sm:text-xl font-bold text-blue-400 mb-3 flex items-center gap-2">
